# Balcony View Images Directory

Place your Marzipano balcony view tiles in this directory.
...
## Balcony Scene Configuration

Update the `balconyScenes` array in `components/BalconyView.tsx`:
...
2. Update the balcony scenes configuration
