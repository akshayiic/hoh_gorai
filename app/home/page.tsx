...
const navItems = [
  {
    ...
    description:
      "Explore connectivity, schools, shopping and infrastructure surrounding Gorai Bluecrest.",
    icon: Map,
    href: "/location",
          ...
          <div className="flex gap-4 items-start text-left">
            ...
            <div>
              ...
              <p className="text-white/60 text-sm max-w-xl">
                Enter the premium 360° interior virtual tour of Gorai Bluecrest.
